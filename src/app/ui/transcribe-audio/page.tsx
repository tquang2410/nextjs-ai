...
export default function TranscribeAudioPage(){
    ...
    const [transcript, setTranscript] = useState<TranscriptResult | null>(null); // Dùng để lưu trữ kết quả chuyển đổi âm thanh thành văn bản
    const [selectedFile, setSelectedFile] = useState<File | null>(null); // Dùng để lưu trữ file âm thanh được chọn
